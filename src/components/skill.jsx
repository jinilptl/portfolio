...
let Skill=({heading,image})=>{
    return(
        <div className="skillcontainer h-[70px] w-[250px] md:h-[88px] md:w-[300px] flex md:justify-between justify-evenly pl-1 pr-1 bg-white shadow-custom2 rounded-[5px] md:mb-0 mb-10 ">
