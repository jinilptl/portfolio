        ...
        <div className="md:w-[795px] md:h-[310px] w-[330px] h-[320px]  rounded-[10px] md:p-[10px] border border-customPurple shadow-custom2 p-[5px] ">
          ...
          <div className="heading  md:mb-0 mb-3">
            <div className="firstheading md:w-[288px] md:h-[62px] ">
              <h1 className="md:text-[36px] text-[25px] font-bold font-roboto md:tracking-normal tracking-wide">SDE Intern(Paid)</h1>
            </div>
            <div className="secondheading md:w-[215px] md:h-[48px] md:mt-[-8px] ">
              <h1 className="md:text-[24px] font-medium font-roboto text-[20px]">Wisflux Tech Labs</h1>
            </div>
          </div>
          ...
          <div className="paradiv  md:h-[65%] flex flex-col justify-around items-center ">
            ...
            <div className="firstpara flex md:w-[656px] md:h-[35px] items-center md:mb-0 mb-4">
             ...
             <p className="md:text-[20px] text-[20px]"><GoDotFill /></p>
              <p className="para md:text-[20px] text-[17px] font-normal md:ml-3 ml-2 md:leading-6 leading-5">
             ...
             <p className="md:text-[20px] text-[20px]"><GoDotFill /></p>
              <p className="para md:text-[20px] text-[17px] font-normal ml-3 md:leading-6 leading-5">
